   ...
   <form action="" method="POST" enctype="multipart/form-data">
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <input type="file" name="image" required class="box" accept="img/jgp, img/jpeg, img/png">
         </div>
      </div>
      <textarea name="details" class="box" required placeholder="enter product details" name="add_product" cols="50" rows="10"></textarea>
...
<section class="show-products">
   ...
   ?>
   <div class="box">
      <div class="price">Rp. <?= number_format($fetch_products['price'], 0, ',', '.'); ?></div>
